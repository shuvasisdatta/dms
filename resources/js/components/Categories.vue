         ...
         <div class="col-12">
             <div class="card">
                <div class="card-header form-inline">
                   ...
                   <div style="margin:0 auto"><h3>Categories</h3></div>
                    ...
                    <app-data-table :columns="columns" 
                        ...
                        <tbody>
                            <tr v-for="category in categories" :key="category.id">
                                ...
                                <td>
                                    <button class="btn btn-success" @click="editModal(category)"><i class="fas fa-edit"></i></button>
                                    <button class="btn btn-danger" @click="destroyData(category.id)"><i class="fas fa-trash"></i></button>
                                </td>
                            </tr>
                        </tbody>
                    </app-data-table>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 v-show="!editMode" class="modal-title" id="ModalTitle">Add Category</h5>
                        <h5 v-show="editMode" class="modal-title" id="ModalTitle">Update Category</h5>
                    ...
                    <form @submit.prevent="editMode? updateData() : createData()" @keydown="form.onKeydown($event)">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <!-- <select v-model="form.parent_id" type="number" name="parent_id"
                                    class="form-control" :class="{ 'is-invalid': form.errors.has('parent_id') }">
    ...
    export default {
        ...
        data() {
            ...
            let columns = [
                ...
                {name: 'parent_id', label: 'Parent', sortable: true, filterable: true },
        ...
        methods: {
            ...
            getParentCategories(url = 'api/fetchAllParentCategories') {
                axios.get(url)
                    .then(response => {
                        let data = response.data;
