             ...
             <div class="card">
               ...
               <div class="card-body table-responsive">
                    <app-data-table :columns="columns" 
                        ...
                        @sort="sortBy">
                        <tbody>
                            <tr v-for="plant in plants" :key="plant.title">
                                <td>{{ plant.name }}</td>
                                <td>{{ plant.created_at }}</td>
                                <td>{{ plant.updated_at }}</td>
                                <td>
                                    <button class="btn btn-success" @click="editModal(plant)"><i class="fas fa-edit"></i></button>
                                    <button class="btn btn-danger" @click="destroyData(plant.id)"><i class="fas fa-trash"></i></button>
                                </td>
                            </tr>
                        </tbody>
                    </app-data-table>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 v-show="!editMode" class="modal-title" id="ModalTitle">Add Plant</h5>
                        <h5 v-show="editMode" class="modal-title" id="ModalTitle">Update Plant</h5>
