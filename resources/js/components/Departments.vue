         ...
         <div class="col-12">
             <div class="card">
               <div class="card-header form-inline">
                   ...
                   <div style="margin:0 auto"><h3>Departments</h3></div>
               ...
               <div class="card-body table-responsive">
                    <app-data-table :columns="columns" 
                        ...
                        @sort="sortBy">
                        <tbody>
                            <tr v-for="department in departments" :key="department.title">
                                <td>{{ department.name }}</td>
                                <td>{{ department.created_at }}</td>
                                <td>{{ department.updated_at }}</td>
                                <td>
                                    <button class="btn btn-success" @click="editModal(department)"><i class="fas fa-edit"></i></button>
                                    <button class="btn btn-danger" @click="destroyData(department.id)"><i class="fas fa-trash"></i></button>
                                </td>
                            </tr>
                        </tbody>
                    </app-data-table>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 v-show="!editMode" class="modal-title" id="ModalTitle">Add Department</h5>
                        <h5 v-show="editMode" class="modal-title" id="ModalTitle">Update Department</h5>
